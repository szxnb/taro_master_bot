...
class MainProcess:
   ...
   def set_taro_user_question(self, value):
      self.taro_user_question = value

   def set_taro_user_card(self, value):
      self.taro_user_card = value
   
   def set_taro_user_email(self, value):
      self.taro_user_email = value
   ...
   def start_process(self):
      print("开始测算")
      # 测算结果
      result_overview = taro_request.make_request(self.url, self.headers, self.payload_overview)
      result_love = taro_request.make_request(self.url, self.headers, self.payload_love)
      result_career = taro_request.make_request(self.url, self.headers, self.payload_career)
      result__finances = taro_request.make_request(self.url, self.headers, self.payload_finances)
      print("开始生成报告")
      print("1/4 总述:\n"  + result_overview)
      print("----------------------------------------------")
      print("2/4 爱情方面:\n" + result_love)
